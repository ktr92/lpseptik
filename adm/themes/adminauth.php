...
<body class="login-page">
	<div id="wrapper">
		<!-- |===============| header start |===============| -->
		<header class="header">
			<a href="http://<insert name="base_url">/" class="logo">
			...
			<div class="header__link">
				<a href="http://<insert name="base_url">/">
		...
		<div class="wrap">
			<form name="auth" method="post" action="" class="login-form">
				...
				<a href="http://<insert name="base_url">/admin_reminding/" class="login-rememb"><insert value="Забыли пароль?"></a>
