...
define("TIT1", 'ЧелныСептик');

//параметры подключения к БД
define("DB_URL", 'mysqli://severk_lpchelny:3&YgJTrm@localhost/severk_lpchelny');
...
define("FTP_LOGIN", 'admin-septik');

//пароль FTP-пользователя
define("FTP_PASSWORD", '364kfhkfk');
