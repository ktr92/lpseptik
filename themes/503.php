...
<head>
  ...
  <style type="text/css">
    ...
    .search-form input[type="submit"] {
      background: url('http://www.diafan.ru/img/error404/search-button.png') no-repeat 0 0;
      width: 17px;
      height: 17px;
      padding: 3px;
      ...
      <div class="container">
        ...
        <div class="logo">
          <a href="<insert name="path">">
            <img src="http://www.diafan.ru/img/error404/logo.png" />
          </a>
        </div>
    ...
    <div class="content">
      <div class="container">
        <div class="error-loupe">
          <img src="http://www.diafan.ru/img/error404/loupe503.png" />
        </div>
