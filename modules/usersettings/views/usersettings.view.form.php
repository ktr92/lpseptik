...
if (! empty($result['link_subscribtion']))
{
	echo '<div class="infofield"><a href="'.$result['link_subscribtion'].'" target="_blank">'.$this->diafan->_('Редактировать категории рассылки').'</a></div>';
}
if (! empty($result["use_subscribtion"]))
{
