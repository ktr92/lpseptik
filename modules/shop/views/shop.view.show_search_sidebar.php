...
echo '<aside class="block shop-search">';
echo '<h3>'.$this->diafan->_('Производители').'</h3>';
...
{
	echo '<div class="shop_search_brand" id="sidebar-brands">';/*
	...
	foreach ($result["brands"] as $row)
	{
		...
		<input type="radio" name="brand[]" value="'.$row["id"].'"';
