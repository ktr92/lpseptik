...
class Shop extends Controller
{
	...
	{
		$attributes = $this->get_attributes($attributes, 'count', 'site_id', 'cat_id', 'brand_id', 'sort', 'images', 'images_variation', 'param', 'hits_only', 'action_only', 'new_only', 'discount_only', 'only_module', 'only_shop', 'tag', 'template');
		...
		$this->model->show_block($count, $site_ids, $cat_ids, $brand_ids, $sort, $images, $images_variation, $param, $hits_only,
