		...
		'main' => array (
			...
			'type' => array(
				...
				'select' => array(
					...
					'rel_goods' => 'Идентификаторы связанных товаров', // идентификаторы через «Разделительz данных внутри поля», только для товаров
					...
					'url_brand' => 'Ссылка на сайт производителя', 
