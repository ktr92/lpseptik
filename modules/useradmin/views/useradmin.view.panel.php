...
<header class="diafan-admin-panel useradmin_panel">
	<a href="'.BASE_PATH.ADMIN_FOLDER.'/" class="diafan-admin-logo">
		...
		<span class="diafan-admin-logo__link">'.BASE_URL.'</span>
	</a>
...
if($this->diafan->_users->useradmin == 1)
{
	...
	foreach($add_pages as $row)
	{
		$html[] = '<div class="diafan-admin-item">
			<a href="'.BASE_PATH_HREF.ADMIN_FOLDER.'/'.$row["rewrite"].'/addnew1/">
	...
	<div class="diafan-admin-unit">
		...
		<a href="'.BASE_PATH.ADMIN_FOLDER.'/users/edit'.$this->diafan->_users->id.'/" class="diafan-admin-settings" title="'.$this->diafan->_('Ваши настройки', false).'"><i class="fa fa-gear"></i></a>
		
		<a href="'.BASE_PATH.ADMIN_FOLDER.'/users/edit'.$this->diafan->_users->id.'/" class="diafan-admin-user" title="'.$this->diafan->_('Ваши настройки', false).'">
