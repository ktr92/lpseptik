...
class Service_admin extends Frame_admin
{
	...
	{
		$rows = $this->get_rows();
		$module_rows = array('news', 'clauses', 'feedback', 'faq', 'shop', 'ab', 'files', 'comments', 'rating', 'tags', 'photo', 'votes', 'subscribtion', 'users', 'forum', 'search', 'map', 'keywords', 'filemanager', 'mistakes');
