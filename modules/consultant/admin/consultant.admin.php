...
class Consultant_admin extends Frame_admin
{
	...
	public function show()
	{
		...
		if(! $this->diafan->configmodules("jivosite_id", "consultant"))
		{
			...
			echo '<p style="margin-top:200px; color:gray;">Если Вы уже регистрировались и у Вас есть идентификатор виджета, внесите их в <a href="?consultant_action=consultant_config_form">настройки модуля</a>.</p>';
		}
		else
		{
