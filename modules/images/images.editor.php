...
<link href="'.BASE_PATH.'css/custom-theme/jquery-ui-1.8.18.custom.css" rel="stylesheet" type="text/css">
...
<script src="'.BASE_PATH.'js/jquery.formstyler.js"></script>
...
<script type="text/javascript" src="'.BASE_PATH.'adm/js/main.js"></script>
<script type="text/javascript" src="'.BASE_PATH.'modules/images/js/images.editor.js"></script>
