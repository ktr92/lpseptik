...
class Filemanager_admin extends Frame_admin
{
	...
	public function show()
	{
		...
		{
			echo '<div class="error">'.$this->diafan->_('Файловый менеджер в демо-версии не доступен.').' <a href="http://www.diafan.ru/dokument/full-manual/modules/filemanager/" target="_blank">'.$this->diafan->_('Смотрите описание модуля в документации').'</a>.</div>';
			return;
		}
