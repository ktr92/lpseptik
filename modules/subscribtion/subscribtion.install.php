...
class Subscribtion_install extends Install
{
	/**
	 * @var string название
	 */
		...
		array(
			...
			"fields" => array(
				...
				array(
					...
					"comment" => "идентификатор категории из таблицы {subscribtion_category}",
				),
				array(
					"name" => "name",
		...
		array(
			...
			"fields" => array(
				...
				array(
					"name" => "parent_id",
					"type" => "INT(11) UNSIGNED NOT NULL DEFAULT '0'",
					"comment" => "идентификатор родителя из таблицы {subscribtion_category}",
				),
				array(
					"name" => "count_children",
		...
		array(
			...
			"fields" => array(
				...
				array(
					"name" => "element_id",
					"type" => "INT(11) UNSIGNED NOT NULL DEFAULT '0'",
					"comment" => "идентификатор рассылки из таблицы {subscribtion}",
				),
				array(
					"name" => "cat_id",
					"type" => "INT(11) UNSIGNED NOT NULL DEFAULT '0'",
		...
		array(
			...
			"fields" => array(
				...
				array(
					"name" => "parent_id",
					"type" => "INT(11) UNSIGNED NOT NULL DEFAULT '0'",
					"comment" => "идентификатор родителя категории из таблицы {subscribtion_category}",
				),
				array(
					"name" => "trash",
					"type" => "ENUM('0', '1') NOT NULL DEFAULT '0'",
		...
		array(
			...
			"fields" => array(
				...
				array(
					"name" => "element_id",
					"type" => "INT(11) UNSIGNED NOT NULL DEFAULT '0'",
					"comment" => "идентификатор подписчика из таблицы {subscribtion_emails}",
				),
				array(
					"name" => "cat_id",
					"type" => "INT(11) UNSIGNED NOT NULL DEFAULT '0'",
	...
	public $site = array(
		array(
			"name" => array('Рассылки', 'Subscribtion'),
			"act" => true,
