...
class Dashboard_admin extends Frame_admin
{
	...
	public function show_h1()
	{
		if (! empty($_GET["help"])) {
	        ...
	        echo '<p><strong>'.$this->diafan->_('Смотрите краткое руководство <a href="http://www.diafan.ru/dokument/full-manual/introduction/pervoe_znakomstvo_s_panelyu_upravleniya_saytom/" target="_blank">Как управлять сайтом</a>.').'</strong></p>';
