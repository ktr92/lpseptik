...
form.submit();});$(document).on('click','.js_shop_add_compare, .shop_compare_button',function(){$(this).parents('form').submit();});$(document).on('click','.js_shop_additional_cost input[type="checkbox"]',function(){cacl_additional_pice($(this).parents('form'));});function cacl_additional_pice(th)
