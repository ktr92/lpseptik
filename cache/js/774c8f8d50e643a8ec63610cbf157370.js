show_param_shop($("#type select"));$("#type select").change(function(){show_param_shop($(this));});$('#attachments_access_admin').remove();function show_param_shop(obj)
{obj.attr("req_self",true);if(obj.val()=="multiple")
{$("#required").show();}
else
{$("#required").hide();}
